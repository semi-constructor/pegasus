...
export const data = new SlashCommandBuilder()
  ...
  .addSubcommand(subcommand =>
    subcommand.setName('view').setDescription('View your registered birthday')
  )
  .addSubcommand(subcommand =>
    subcommand
      .setName('config')
      ...
      .addChannelOption(option =>
        option
          .setName('channel')
          .setDescription('Channel to send birthday messages in')
          .setRequired(true)
      )
      .addBooleanOption(option =>
        option
          .setName('enabled')
          .setDescription('Enable or disable birthday messages')
          .setRequired(false)
      )
      .addStringOption(option =>
        option
          .setName('message')
          .setDescription('Custom birthday message (use {user} to mention)')
          .setRequired(false)
      )
  );
